...
import com.dj.hahajoke.databinding.ActivityLayoutCaptureBinding;
import com.dj.hahajoke.view.RecordView;
...
public class CaptureActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding.recordView.setOnRecordListener(new RecordView.onRecordListener() {
            ...
            public void onClick() {
                takingPicture = true;
                File file = new File(getExternalFilesDir(Environment.DIRECTORY_PICTURES), System.currentTimeMillis() + ".jpeg");
            ...
            public void onLongClick() {
                ...
                // 这种方法创建文件未成功，下面onError中会报错：MediaMuxer creation failed
